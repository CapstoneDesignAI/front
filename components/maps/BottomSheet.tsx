...
export default function BottomSheet() {
  ...
  return (
    <Animated.View
      className="absolute bottom-0 left-0 right-0 rounded-t-[24px] bg-main-05 pb-[18px] shadow-xl border border-gray-04"
    ...
    >
      ...
      >
        <View className="h-1 w-[42px] rounded-full bg-main-02" />
      </View>
      <BottomSheetHeader
